...
//Change Hesham/Venkat Method flushQueue
//often Sanity Check is happening and Killing the background task and so we commented "stopBackgroundTask" method thus we don't happen to stop any backgroundtask.
- (void) flushQueue
{
    ...
    if (bgTask != UIBackgroundTaskInvalid) {
        if (-[lastBgTaskAt timeIntervalSinceNow] > 30.0) {
            ...
            //[self stopBackgroundTask]; //Change Hesham/Venkat
        }
        return;
    }
...
//    [self stopBackgroundTask];
 ...
 //Change Hesham/Venkat didUpdateLocation
- (void) locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    //saveBatteryOnBackground always returning T
